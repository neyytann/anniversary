...
const _milestones = [
  _Milestone('June 2025', 'The beginning',
      'The day everything changed — when two hearts decided to write a story together. A moment neither of us will ever forget.'),
  _Milestone('August 2025', 'First adventure together',
      'Exploring somewhere new with you — where every detour became a favorite memory and every laugh echoed a little longer.'),
  _Milestone('December 2025', 'The holidays, with you',
      'The warmth of the season felt different — brighter, softer, and entirely more meaningful because you were there beside me.'),
  ...
  void initState() {
    ...
    _opacities = List.generate(_milestones.length, (i) {
      ...
      return Tween(begin: 0.0, end: 1.0).animate(
        CurvedAnimation(
          parent: _ctrl,
          curve: Interval(start, (start + 0.35).clamp(0, 1), curve: Curves.easeOut),
        ),
      );
    });
          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Color(0xFF332620), AppColors.charcoal, Color(0xFF251C18)],
                stops: [0.0, 0.5, 1.0],
              ),
            ),
          ),

          // Decorative vertical line (center on desktop, left on mobile)
          Positioned(
            left: isMobile ? 32 : size.width / 2,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Timeline items - evenly spaced in remaining space
                Expanded(
                  child: isMobile
                      ? _mobileTimeline()
                      : _desktopTimeline(size),
                ),
              ],
            ),
          ),
    ...
    return Column(
      ...
      children: [
        Text(m.date.toUpperCase(),
            textAlign: align,
            style: GoogleFonts.jost(
              fontSize: 9.5, fontWeight: FontWeight.w200,
              letterSpacing: 3, color: AppColors.gold,
            )),
        const SizedBox(height: 5),
        Text(m.title, textAlign: align,
            style: GoogleFonts.cormorantGaramond(
              fontSize: 22, fontWeight: FontWeight.w300,
              color: AppColors.cream, height: 1.2,
            )),
        const SizedBox(height: 6),
        Text(m.description, textAlign: align,
            style: GoogleFonts.cormorantGaramond(
